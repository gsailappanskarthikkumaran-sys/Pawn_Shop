...
import { addGoldRate, getLatestGoldRate, addScheme, getSchemes, deleteScheme, deleteGoldRate, updateDeductions, getDeductions } from '../controllers/masterController.js';
...
router.route('/deductions').get(protect, getDeductions).post(protect, admin, updateDeductions);
