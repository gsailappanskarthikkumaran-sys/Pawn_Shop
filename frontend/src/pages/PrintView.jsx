...
const LoanReceipt = ({ loan, copyType }) => (
    <div className="loan-receipt-v2 mono uppercase">
        ...
        <div className={loan.items?.length > 4 ? 'force-break-before' : ''}>
            {/* 6. Acknowledgement */}
    ...
    <div className="terms-conditions-page mono">
        <div className="terms-section">
            <div className="force-break-before">
                <h3 className="bold" style={{ marginBottom: '30px', fontSize: '20px' }}>விதிமுறைகள் மற்றும் நிபந்தனைகள்</h3>
        ...
        <div className="terms-section page-break" style={{ marginTop: '0' }}>
            <div className='force-break-before'>
                ...
                <div style={{ marginTop: '40px', textAlign: 'right' }} className="bold">BORROWER’S SIGNATURE</div>
            </div>
        </div>
    </div>
);
